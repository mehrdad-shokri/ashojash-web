...
@section('content')
    <div class="shadow-1 col-xs-12 white-bg bor-ra-10">
        <div class="col-xs-9">  {!! Form::open(array('class'=>'dropzone','action'=>array('Admin\CollectionsController@addPhoto',$collection->slug))) !!}
            {!! Form::close() !!}</div>
        <div class="col-xs-12 col-md-6">
            <img src="{{action('PhotosController@getCollectionPhoto',$collection->slug)}}" style="max-width: 100%" alt="">
        </div>
