<div class="row top-xs-5">
    ...
    @if($schedules->count()>0)
        <div class="row top-xs-10 hidden" id="timings-all">
            {{--suspecious--}}
            <div class="col-xs-12 top-xs-5">
                <?php $daySchedules = $schedules->where('day', 6);?>
                @if($daySchedules->count()>0)
                    ...
                    <div class="col-xs-3">
                        @if(($currentDaySchedules->count()!=0) &&( $currentDaySchedules->first()->day==$daySchedules->first()->day))
