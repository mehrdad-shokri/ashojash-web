<div class="right-xs-40" id="reviews-container">
    @foreach($reviews as $review)
        <div class="row top-xs-40 review">
            <div>
                <div class="col-xs-9 float-children-right  pr-0  pb-5 review-header pull-right">
                    ...
                    <div class="col-xs-9 col-sm-9 col-md-10 pr-0 right-xs-10">
                        ...
                        <div class="col-xs-12 pr-0 top-xs-5"><a
    ...
    padding-bottom: 5px;">
                    ...
                    <i class="text-muted" style="font-size: 12px"><span>توسط </span><a class="text-muted"
                                                                                       style="color: #405FE3"
                                                                                       href="{{action("UsersController@show",$review->user->username)}}">{{$review->user->username}}</a></i>

                    <div class="top-xs-5">
                        <p class="rtl" style="color: #444">
