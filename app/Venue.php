...
class Venue extends Model {
	...
	protected $fillable = ['name', 'details', 'phone', 'mobile', 'url', 'instagram', 'status', 'starts_at', 'valid_until', 'score', 'cost', 'type'];
	...
	{
		return $this->belongsToMany('App\Tag')->withPivot(['weight'])->withTimestamps();
	}
